...
var ActorModels_1 = require("../ActorModels");
exports.MockActorConnector = {
    actor: function (id) {
            ...
            return __generator(this, function (_a) {
                for (i = 0; i < db.length; i++) {
                    ...
                    if (element.actor_id === id) {
                        return [2 /*return*/, new ActorModels_1.Actor(element.actor_id, element.actor_name, element.actor_surname)];
                    }
                }
    ...
    actors: function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, db.map(function (i) { return new ActorModels_1.Actor(i.actor_id, i.actor_name, i.actor_surname); })];
            });
        });
    },
